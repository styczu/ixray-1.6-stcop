...
// Stub for the engine's Msg() logging call used by the TEMP DIAGNOSTIC lines in the
// production bodies below; this test does not check log output, only that it compiles.
